...
func (r *CommonResponse) CheckParamFailed(ParamName string) *CommonResponse {
	r.Status = ReplyStatusInvalidParam
	r.Message = fmt.Sprintf(ReplyMessageInvalidParam, ParamName)
	return r
}
